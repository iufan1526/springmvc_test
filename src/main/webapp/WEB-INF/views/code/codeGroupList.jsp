...
<input type="text" name="shValue"><br>
	...
	<c:choose>
		...
		<c:otherwise>
			...
			<c:out value="${item.ifcgSeq}"/> |<a href="/infra/code/codeGroupView?ifcgSeq=${item.ifcgSeq}"><c:out value="${item.ifcgName}"/><c:out value="${item.ifcgNameEng}"/></a> | <c:out value="${item.ifcgDelNy}"/> <br>
